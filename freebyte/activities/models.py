...
class Notification(models.Model):
    ...
    _LIKED_TEMPLATE = '<a href="/{0}/">{1}</a> 赞了你的帖子: <a href="/feeds/{2}/">{3}</a>'  # noqa: E501
    _COMMENTED_TEMPLATE = '<a href="/{0}/">{1}</a> 评论了你的帖子: <a href="/feeds/{2}/">{3}</a>'  # noqa: E501
    _FAVORITED_TEMPLATE = '<a href="/{0}/">{1}</a> 收藏了你的问题: <a href="/questions/{2}/">{3}</a>'  # noqa: E501
    _ANSWERED_TEMPLATE = '<a href="/{0}/">{1}</a> 回答了你的问题: <a href="/questions/{2}/">{3}</a>'  # noqa: E501
    _ACCEPTED_ANSWER_TEMPLATE = '<a href="/{0}/">{1}</a> 采纳了你的答案: <a href="/questions/{2}/">{3}</a>'  # noqa: E501
    _UPVOTED_QUESTION_TEMPLATE = '<a href="/{0}/">{1}</a> 赞同了你的问题: <a href="/questions/{2}/">{3}</a>'  # noqa: E501
    _UPVOTED_ANSWER_TEMPLATE = '<a href="/{0}/">{1}</a> 赞同了你的答案: <a href="/questions/{2}/">{3}</a>'  # noqa: E501
    _EDITED_ARTICLE_TEMPLATE = '<a href="/{0}/">{1}</a> 编辑了你的文章: <a href="/article/{2}/">{3}</a>'  # noqa: E501
    _ALSO_COMMENTED_TEMPLATE = '<a href="/{0}/">{1}</a> 也评论了帖子: <a href="/feeds/{2}/">{3}</a>'  # noqa: E501
    _USER_LOGIN_TEMPLATE = '<a href="/{0}/">{1}</a> 上线了.'  # noqa: E501
    _USER_LOGOUT_TEMPLATE = '<a href="/{0}/">{1}</a> 下线了.'  # noqa: E501
